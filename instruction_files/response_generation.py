...
instruction_dict = {
	"id": "wow",
    "Definitions": ["In this task you will be shown a conversation context. You need to generate a response to the conversation conditioned on the context.",
                    "Provide a response to the conversation",
                    "Generate a response to the conversation",
                    "Generate a response to the dialogue",
                    "Generate a coheent response to the conversation",
                    "Given the conversation, return a response"],
    "Positive Examples": [
        {
    ...
    def generate_data(self):
        ...
        for d, dataset_reader in enumerate(self.data_readers):
            ...
            for dp in tqdm(datapoints):
                ...
                post_prompts = [settings.QUESTION_SEP+" Given this context, the response is",
                                settings.QUESTION_SEP+" Generate a response for the provided context",
                                settings.QUESTION_SEP+" Given this context generate a response coherent to the context",
                                settings.QUESTION_SEP+" Here is a response which is a good follow-up to the context"]
